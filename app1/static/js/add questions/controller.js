...
function printRecord(itemObject){
    ...
    var deleteIcon = printIcon('../static/images/delete.png','imagestyle',markForDelete,itemObject.id);
    var td = tr.insertCell(index);
    td.appendChild(deleteIcon);
    var editIcon = printIcon('../static/images/edit.png','imagestyle',editRecord,itemObject.id);
